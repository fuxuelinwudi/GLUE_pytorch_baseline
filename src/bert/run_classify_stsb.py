...
def train(args):
    ...
    for epoch in range(1, args.num_epochs + 1):
        ...
        for batch in train_iterator:
            ...
            if (global_steps + 1) % args.logging_step == 0:
                ...
                metric = evaluation_psc(args, model, dev_dataloader)
                pc, avg_val_loss = metric['pc'], metric['avg_val_loss']
                ...
                if pc > best_pc_score:
                    ...
                    print(f'\n>>>\n    best pearson corr - {best_pc_score}, '
    ...
    metric = evaluation_psc(args, best_model, dev_dataloader)
    pc, avg_val_loss = metric['pc'], metric['avg_val_loss']

    print(f'\n>>>\n    best pearson corr - {best_pc_score}, dev loss - {avg_val_loss} .')
    os.makedirs(os.path.join(args.output_path, f'acc-{best_pc_score}'), exist_ok=True)
