...
def main(task_type):
    ...
    parser.add_argument('--dev_path', type=str,
                        default=f'../../download_datasets/data/{task_type}/valid_mismatched.tsv')
    ...
    parser.add_argument('--logging_step', type=int, default=3681)  # evaluate 10 times
